...
#        model = WhisperModel(modelsize, device="cpu", compute_type="int8") #, download_root="faster-disk-cache-dir/")
    ...
    def transcribe(self, audio, init_prompt=""):
        ...
        # beam_size=5 with temperature=0.0 for better accuracy on proper nouns
        segments, info = self.model.transcribe(audio, language=self.original_language, initial_prompt=init_prompt, beam_size=5, temperature=0.0, word_timestamps=True, condition_on_previous_text=True, **self.transcribe_kargs)
