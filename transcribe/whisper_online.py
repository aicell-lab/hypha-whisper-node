# vendored from https://github.com/ufal/whisper_streaming commit 6da90b44b7e50d79695e68166d2a2c7609c75abb
#!/usr/bin/env python3
import sys
import numpy as np
import librosa
...
#        model = WhisperModel(modelsize, device="cpu", compute_type="int8") #, download_root="faster-disk-cache-dir/")
    ...
    def transcribe(self, audio, init_prompt=""):
        ...
        # tested: beam_size=1 is faster and better than 1 (on one 200 second document from En ESIC, min chunk 0.01)
        segments, info = self.model.transcribe(audio, language=self.original_language, initial_prompt=init_prompt, beam_size=1, word_timestamps=True, condition_on_previous_text=True, **self.transcribe_kargs)
...
class VACOnlineASRProcessor(OnlineASRProcessor):
    ...
    def process_iter(self):
        if self.is_currently_final:
            ...
            #print("no online update, only VAD", self.status, file=self.logfile) # we comment out it because it will keep printing.
            return (None, None, "")
